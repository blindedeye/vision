...
Photoshop uses the following ranges: H: 0-360, S: 0-100, V: 0-100
...
def main() -> None:
    ...
    part2()
    part3() # works mostly
    part4() # Couldn't figure out how to get the yield/traffic light to work with this (blur is prob softening the sharp edges)
    # part5() # Didn't do this one lol
    # img = cv2.imread("example_all_signs.jpg")
    # cv2.imshow("test", img)
    # cv2.waitKey(0)
...
def part1() -> None:
    ...
    for tl in tl_images:
        ...
        identify_traffic_light(tl_image)
