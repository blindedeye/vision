...
def main() -> None:
    ...
    stereo = cv2.StereoSGBM_create(minDisparity=1, numDisparities=64, blockSize=5, speckleWindowSize=200, speckleRange=2)
    ...
    filtered_disparity_map = wls.filter(disp, img_left_gray, filtered_disparity_map=disp_right)
